...
import bluepanther.envirinsta.Adapter.*;
    ...
    private  static class MyOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (TimeContent.grpcontent.get(position).getType().equals("Images")) {
                String res = TimeContent.grpcontent.get(position).getAuthor() + TimeContent.grpcontent.get(position).getTime();
                Intent i=new Intent(context, Dis_image.class);
                i.putExtra("res",res);
                i.putExtra("title",TimeContent.grpcontent.get(position).getMember_name());
                i.putExtra("categ",TimeContent.grpcontent.get(position).getStatus());
                i.putExtra("auth",TimeContent.grpcontent.get(position).getAuthor());
